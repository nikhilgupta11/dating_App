        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('setting_controller')}}">Setting</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('cms_index')}}">Content Pages</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
